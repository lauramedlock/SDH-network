...
cfg.Ab_EX_AMPA =             0.000170596
cfg.Ab_EX_NMDA =             0.007412745
cfg.Ab_IN_AMPA =             0.012342634
cfg.Ab_IN_NMDA =             0.490892533
cfg.Ad_AMPA =                0.482606317 *0
cfg.Ad_NMDA =                0.205306104 *0
cfg.C_EX_AMPA =              0.477300879 *0
cfg.C_EX_NMDA =              0.011442423 *0
cfg.C_TrC_AMPA =             0.446783086 *0
cfg.C_DYN_AMPA =             0.347433195 *0
cfg.C_ISLET_AMPA =           0.301992543 *0
cfg.C_NK1_AMPA =             0.118724465 *0
cfg.C_NK1_NMDA =             0.021496961 *0
cfg.C_NK1_NK1 =              2.18E-07    *0
cfg.VGLUT3_PKC_AMPA =        0.00103357
cfg.VGLUT3_PKC_NMDA =        0.241783555
cfg.PV_GABA =                0.406278807 *0
cfg.PV_GLY =                 0.407968195 *0
cfg.DYN_ISLET_GABA =         0.243205522 *0
cfg.ISLET_GABA =             0.228094876 *0
cfg.DYN_EX_GABA =            0.363840388 *0
cfg.DYN_EX_GLY =             0.484141169 *0
cfg.PKC_AMPA =               0.174262049
cfg.PKC_NMDA =               0.037816281
cfg.TrC_AMPA =               0.22604748
cfg.TrC_NMDA =               0.495681799
cfg.VGLUT3_SOM_AMPA =        0.114037447
cfg.VGLUT3_SOM_NMDA =        0.305831066
cfg.DOR_AMPA =               0.031106828
cfg.DOR_NMDA =               0.082908436
cfg.EX_NK1_AMPA =            0.455135672
cfg.EX_NK1_NMDA =            5.42E-06
cfg.EX_NK1_NK1 =             9.99E-07
cfg.DYN_NK1_GABA =           0.021261357 *0
cfg.DYN_NK1_GLY =            0.068805686 *0
...
# SAVING
cfg.simLabel = '25mN-IRB-Cblock-CandJ'
