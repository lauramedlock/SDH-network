...
cfg.AB_ratio = 0.2    # 0mN -> 0.001, 5mN->0.1, 10mN->0.2, 15mN->0.3, 20mN->0.4, 25mN->0.5, 50mN->1.0, 100mN->1.0, 200mN -> 1.0, 400mN -> 1.0, 800mN --> 1.0
...
# SAVING
cfg.simLabel = '10mN-AltTuning-IRB'
