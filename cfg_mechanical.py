...
cfg.AB_ratio = 0.6    # 0mN -> 0.001, 5mN->0.1, 10mN->0.2, 15mN->0.3, 20mN->0.4, 25mN->0.5, 30mN->0.6, 50mN->1.0, 100mN->1.0, 200mN -> 1.0, 400mN -> 1.0, 800mN --> 1.0

cfg.freq = '30mN' #Change freq to match the stimulus given above
...
cfg.PV_GABA = 0.29416            *0.1      #0.6  #alt tuning (7C)
cfg.PV_GLY =  0.011521           *0.1      #0.6  #alt tuning (7C)
cfg.DYN_ISLET_GABA = 0.36182     *0.1    
cfg.ISLET_GABA = 0.34293         *0.1    
cfg.DYN_EX_GABA = 4.50e-05       *0.1      #*25  #alt tuning (7C)
cfg.DYN_EX_GLY = 4.50e-05        *0.1      #*25  #alt tuning (7C)
cfg.PKC_AMPA = 0.0021
...
cfg.DYN_NK1_GABA = 6.3720e-06    *0.1  
cfg.DYN_NK1_GLY = 2.3608e-06     *0.1  

cfg.recordTraces['vs'] = {'sec':'soma', 'loc':0.5,'var':'v'}

# SAVING
cfg.simLabel = '30mN-IRB-100'
