...
cfg.freq = '10mN' #Change freq to match the stimulus given above
...
cfg.PV_GABA =                0.421640668   *0.65  *0
cfg.PV_GLY =                 0.174798964   *0.65  *0
cfg.DYN_ISLET_GABA =         0.335214978   *0.65  *0
cfg.ISLET_GABA =             0.000295429   *0.65  *0
cfg.DYN_EX_GABA =            5.93E-07      *0.02  *0
cfg.DYN_EX_GLY =             0.425370959   *0.02  *0
...
cfg.DYN_NK1_GABA =           0.000542035   *0.02  *0
cfg.DYN_NK1_GLY =            0.116383779   *0.02  *0
...
# SAVING
cfg.simLabel = '10mN-CANDF-Rescaled-Dis'
