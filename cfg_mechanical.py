...
cfg.C_EX_AMPA = 0.00067115     *0
cfg.C_EX_NMDA = 0.000407345    *0
cfg.C_TrC_AMPA = 0.164705      *0       
cfg.C_DYN_AMPA = 0.184135      *0       
cfg.C_ISLET_AMPA = 0.123535    *0         
cfg.C_NK1_AMPA = 0.00009       *0
cfg.C_NK1_NMDA = 8.7447e-05    *0
